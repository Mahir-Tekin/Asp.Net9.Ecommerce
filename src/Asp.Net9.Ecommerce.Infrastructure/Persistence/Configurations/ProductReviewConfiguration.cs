...
namespace Asp.Net9.Ecommerce.Infrastructure.Persistence.Configurations
{
    public class ProductReviewConfiguration : IEntityTypeConfiguration<ProductReview>
    {
        public void Configure(EntityTypeBuilder<ProductReview> builder)
        {
            ...
            // Constraints (quoted for PostgreSQL case sensitivity)
            ...
            builder.HasIndex(r => new { r.ProductId, r.DeletedAt }).HasDatabaseName("IX_ProductReviews_ProductId_DeletedAt"); // For active reviews per product
